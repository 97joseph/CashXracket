...
Route::group(['middleware' => ['auth:sanctum', 'verified', 'admin']], function () {
    ...
    Route::resource('spins', Admin\SpinController::class)->only('index', 'store');
    Route::resource('videos', Admin\AcnooVideoController::class)->except('create', 'show');
    Route::get('watched-videos', [Admin\AcnooVideoController::class, 'watchedVidoes'])->name('watched-videos');
    
    Route::resource('earnings', Admin\EarningController::class)->except('show');
...
Route::resource("survey-completed/", Admin\InbrainController::class)->only('index');
