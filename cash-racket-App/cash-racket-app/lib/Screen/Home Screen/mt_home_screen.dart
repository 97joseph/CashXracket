...
import 'package:cash_rocket/Screen/Visit%20Website/visit_website.dart';
...
import '../Scratch Card/scratch_card.dart';
                        ...
                        Row(
                          ...
                          children: [
                            Expanded(
                              child: GestureDetector(
                                onTap: (){
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=>const VisitWebsite()));
                                },
                                child: Column(
                                  children: [
                                    const Image(
