...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('adnetworks', function (Blueprint $table) {
            ...
            $table->string('pollfish_andriod_key')->nullable();
            $table->string('pollfish_ios_key')->nullable();
            $table->string('bitlabs_andriod_key')->nullable();
            $table->string('bitlabs_ios_key')->nullable();
            $table->string('inbrain_api_key')->nullable();
            $table->timestamps();
        });
    }
