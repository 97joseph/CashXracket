                        ...
                        <div class="order-form-section">
                            <form action="{{ route('update-adnetwork', $info->id) }}" method="post" class="ajaxform" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 mt-2">
                                        <label>{{ __('Pollfish Integration Id(Andriod)') }}</label>
                                        <input type="text" name="pollfish_andriod_key" class="form-control" value="{{ $info->pollfish_andriod_key ?? '' }}" aria-invalid="false">
                                    </div>
                                    <div class="col-sm-6 mt-2">
                                        <label>{{ __('Pollfish Integration Id(IOS)') }}</label>
                                        <input type="text" name="pollfish_ios_key" class="form-control" value="{{ $info->pollfish_ios_key ?? '' }}" aria-invalid="false">
                                    </div>
                                    <div class="col-sm-6 mt-2">
                                        <label>{{ __('Bitlabs integration Id (Andriod)') }}</label>
                                        <input type="text" name="bitlabs_andriod_key" class="form-control" value="{{ $info->bitlabs_andriod_key ?? '' }}" aria-invalid="false">
                                    </div>
                                    <div class="col-sm-6 mt-2">
                                        <label>{{ __('Bitlabs integration Id (IOS)') }}</label>
                                        <input type="text" name="bitlabs_ios_key" class="form-control" value="{{ $info->bitlabs_ios_key ?? '' }}" aria-invalid="false">
                                    </div>
                                    <div class="col-sm-6 mt-2">
                                        <label>{{ __('Inbrain Api Key') }}</label>
                                        <input type="text" name="inbrain_api_key" class="form-control" value="{{ $info->inbrain_api_key ?? '' }}">
                                    </div>
