...
class User extends Authenticatable
{
     ...
     * @var array
     */
    protected $fillable = ['name', 'last_name', 'email', 'password', 'phone', 'image', 'refer', 'user_type', 'refer_code', 'facebook_token', 'google_token', 'status', 'email_verified_at', 'access_date',
    ];
