                        ...
                        <div class="order-form-section">
                            <form action="{{ route('new-quiz') }}" method="post" class="add-brand-form ajaxform_instant_reload" id="add-brand-form" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mt-2 free_or_paid d-none">
                                        <label>{{__('Entry Fee')}}</label>
                                        <input type="number" name="free_or_paid" class="form-control" placeholder="Enter entry fee" required>
                                    </div>
                                    <div class="col-lg-6 mt-2">
