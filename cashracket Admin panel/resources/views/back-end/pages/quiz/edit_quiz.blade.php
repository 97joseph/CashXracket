                        ...
                        <div class="order-form-section">
                            <form action="{{route('update-quiz',['id'=> $info->id])}}" method="post" class="add-brand-form ajaxform_instant_reload" id="add-brand-form" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mt-2 free_or_paid {{ $info->paid_status == 1 ? '':'d-none' }}">
                                        <label>{{__('Entry Fee')}}</label>
                                        <input type="number" name="free_or_paid" class="form-control" value="{{ $info->free_or_paid }}" placeholder="Enter entry fee" required>
                                    </div>
                                    <div class="col-lg-6 mt-2">
                                    ...
                                    <div class="col-lg-6 mt-2">
                                        <div class="row">
                                            ...
                                            <div class="col-1 ps-0 mt-4 align-self-center">
